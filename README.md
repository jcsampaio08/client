...
Bot autonomo para o desafio de Inteligencia Artificial da INF1771. O codigo de rede do devkit foi mantido; a logica principal fica em `src/GameAI.py`.
...
2. Fazer tiros curtos de continuacao quando um disparo acabou de acertar.
...
6. Girar ao ouvir passos para tentar colocar o inimigo na mira.
7. Explorar com A* ate a fronteira segura mais proxima.
...
- `andar_re`: move para tras para fugir, destravar ou seguir um alvo seguro atras do drone.
...
- O bot ainda e conservador: evita celulas com evidencia ativa de poco ou teleporte, entao pode ficar girando se todos os caminhos conhecidos parecerem perigosos.
...
Preencher com os integrantes do grupo antes da entrega.
